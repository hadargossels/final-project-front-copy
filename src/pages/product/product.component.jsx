...
function ProductPage(props) {
  ...
  const [collectionsDisplay, setSelectedCollection] = useState([]);
      ...
      for (let i = 0; i < arrOfArr.length && !imgFound; i++) {
        for (let j = 0; j < arrOfArr[i].length; j++) {
          if (arrOfArr[i][j].name === productName) {
            ...
            setPrice(arrOfArr[i][j].price);
            setImageUrl(arrOfArr[i][j].imageUrl);
            setImage1(arrOfArr[i][j].image1);
            setImage2(arrOfArr[i][j].image2);
            setName(arrOfArr[i][j].name);
            setDescription(arrOfArr[i][j].description);
            setId(arrOfArr[i][j].id);
            setMainImage(arrOfArr[i][j].imageUrl);
            setImgFound(true);
            break;
          }
        }
                  ...
                  <div className="col-lg-2 order-lg-1 order-2">
                    <ul className="image_list">
                      ...
                      <li data-image={image1}>
                        <img onClick={changeImage} src={image1} alt />
                      </li>
                      <li data-image={image2}>
                        <img onClick={changeImage} src={image2} alt />
                      </li>
                    </ul>
                  </div>
                        ...
                        <div className="bbb_combo">
                          <div className="bbb_combo_image">
                            <img
                              ...
                              src="https://ae01.alicdn.com/kf/Hb53f4aa463b849589024084143b3ef9a2/Pet-Flying-Discs-Dog-Training-Ring-Puller-Resistant-Bite-Floating-dog-toys-Interactive-Game-Playing-Products.jpg_220x220xz.jpg_.webp"
                              alt
                            />
                          </div>
                      ...
                      <div className="col-md-5 padding-0">
                        <div className="bbb_combo">
                          <div className="bbb_combo_image">
                            <img
                              className="bbb_combo_image"
                              src="https://ae01.alicdn.com/kf/H32a3446db1f546078882857aff71e6d03/17cm-31cm-40cm-Screaming-Chicken-Dog-Toys-Squeeze-Sound-Pet-Cat-Toy-Dogs-Toys-for-Large.jpg_220x220xz.jpg_.webp"
                              alt
                            />
                          </div>
                          <div className="d-flex flex-row justify-content-start">
                      ...
                      <tbody>
                        <tr className="row mt-10">
                          ...
                          <td className="col-md-8">
                            <ul>
                              <li>
                                2 in 1 dog, User Guide, Warranty Documents
                              </li>
                            </ul>
                          </td>
                        </tr>
