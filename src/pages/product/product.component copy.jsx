...
import { fetchData } from "../../contexts/collections/fetchData";
import { fireInfo } from "../../firebase/firebase.utils";

function ProductPage(props) {
  // const [collectionsMap, setCollection] = useState([]);
  ...
  //   const collectionsMap = useContext(data);
  //   const collections = !loading
  //     ? Object.keys(collectionsMap).map((key) => collectionsMap[key])
  //     : [];
  // const collections = [];
