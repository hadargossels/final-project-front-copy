...
export default class CartPaymentGuestReview extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({paypal: <PayPal total={this.state.callRef} emptyProductCart={this.props.location.params.emptyProductCart}/>})
  }
            ...
            <div className="col-sm">
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Phone: {this.props.location.review[2].value}</td>
                    <td>&emsp;</td>
