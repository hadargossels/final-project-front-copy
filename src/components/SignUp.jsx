    ...
    render() {
        return (
            <div className="mx-3" style={{width: "80%"}}>
                <h1 className="display-4 mb-3" style={{fontSize: "32px"}}>Sign-up</h1>
                <form>
                    ...
                    <button type="submit" className="btn btn-primary align-middle" onClick={this.submitRegistration}>Submit</button>
                    </div>                   
                </form>
            </div>
        );
