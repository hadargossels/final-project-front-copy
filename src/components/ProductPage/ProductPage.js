      ...
      return(
         <div className="ProductDiv">
            <div className="detailsProduct">
               ...
               <input id="amountProduct" type="number" name="amount" value="0" min="0"/>
