   ...
   return (
      ...
      <div>
         ...
         <div className="row">
            ...
            <br></br>  
            <img onClick={this.updateState} src={T1} className="smallPics mx-auto d-block cursor"></img>
            <br></br>  
            <img onClick={this.updateState} src={T1_scale2} className="smallPics mx-auto d-block cursor"></img>
            <br></br>
            <img onClick={this.updateState} src={T1_scale3} className="smallPics mx-auto d-block cursor"></img>
            <br></br> 
            <img onClick={this.updateState} src={T1_scale4} className="smallPics mx-auto d-block cursor"></img>
            </div>
            <div className="col-6">
            <br/><br/>

            <img src={this.state.Image} className="bigImg mx-auto d-block cursor"></img>
