...
export default class Oneblog extends Component {
  ...
  saveComment(e){
    ...
    e.preventDefault()
      ...
      for(let i=0;i<commentDetails.length;i++){
          ...
          switch(item.name){
            case "name" : oneComment.name=item.value
                item.value=""
                break;
            case "email" : oneComment.email=item.value
                item.value=""
                break;
            case "comment" : oneComment.comment=item.value
                item.value=""
                break;
            default: 
                break;
  ...
  getBlog() {
    let myBlog = dataBlog.filter((item) => item.name == this.state.nameOfBlog);
      ...
      <div style={{ margin: "0 auto" }}>
        <div style={{ margin: "2rem 200px", fontFamily: "cursive" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <img src={this.state.myBlog.src} style={{ width: "50%",minWidth:"300px" }} />
          </div>
          <div
            style={{
              margin: "2rem 100px",
          ...
          <div style={{ margin: "2rem 100px", fontSize: "20px",minWidth:"400px" }}>
        ...
        <div style={{ margin: "2rem 300px", fontFamily: "cursive" }}>
          ...
          <form>
            <label>Comment</label>
            <br />
            <textarea className="inputComment" cols="70" rows="6" name="comment" maxLength="100" style={{ resize: "none" }} />
            <br />
            ...
            <button onClick={(e)=>this.saveComment(e)} className="btn btn-danger">
              add comment
            </button>
          </form>
          ...
          <div style={{ marginTop: "2rem" }}>
            <h4>Comments</h4>
            <span style={{ fontSize: "12px", color: "grey" }}>{len}&nbsp; comments</span>
            <div style={{ border: "1px solid grey", minHeight: "5rem",minWidth:"400px" }}>
